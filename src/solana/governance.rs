...
/// SPL Governance program ID: `GovER5Lthms3bLBqWub97yVrMmEogzX7xNjdXpPPCVZw`
pub const GOVERNANCE_PROGRAM_ID: [u8; 32] = [
    0xEA, 0xE4, 0x35, 0xBD, 0xEE, 0x75, 0xB7, 0x34, 0xCD, 0x59, 0x3E, 0xCF, 0x9A, 0x30, 0x4B, 0x80,
    0x24, 0xBA, 0x28, 0x98, 0x67, 0xB7, 0x69, 0xB1, 0xF9, 0x3C, 0xA7, 0xBB, 0xB8, 0x8E, 0x46, 0xFE,
];
